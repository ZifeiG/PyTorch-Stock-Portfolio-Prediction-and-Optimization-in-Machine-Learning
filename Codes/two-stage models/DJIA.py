...
train_path = os.path.join(base_dir, "Raw Datasets", "train_DJIA.csv")
test_path = os.path.join(base_dir, "Raw Datasets", "test_DJIA.csv")

save_dir = os.path.join(base_dir, "Codes", "2-Stage")
os.makedirs(save_dir, exist_ok=True)

alpha_results_path = os.path.join(save_dir, "DLinear_EMA_alpha_search_train_DJIA.csv")
test_portfolio_results_path = os.path.join(save_dir, "DLinear_Markowitz_test_results_DJIA.csv")
