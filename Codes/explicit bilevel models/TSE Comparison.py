...
def train_compare(loader, gross_data, cost_vec, amax, rho, epochs, lr, save_dir, cap_factor):
    ...
    out_path = os.path.join(save_dir, "bilevel_comparison_final_TSE.csv")
...
if __name__ == "__main__":
    ...
    data_path = os.path.join(base_dir, "Raw Datasets", "train_TSE.csv")
    ...
    save_dir = r"C:\Users\19043\Desktop\Thesis\Results and Plots\Bilevel 2\TSE"
